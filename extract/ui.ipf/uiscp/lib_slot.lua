...
function SET_SLOT_PHARMACY_MARK(slot)
	local pharmacy_icon = slot:CreateOrGetControl('picture', slot:GetName() .. '_PharmacyIcon', 58, 58, ui.RIGHT, ui.TOP, 0, 0, 0, 0)
